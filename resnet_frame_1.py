# -*- coding: utf-8 -*-
"""ResNet_Frame_1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1FWyyyZD79LrFgOSpzQmeAkbGLlD2jAgS
"""
...
class ResNet_DQN(nn.Module): ##  num_clss to action_size;
    ...
    def __init__(self, block, layers, action_size=6, in_channels=1):
        self.inplanes = 64
...
def resnet18_DQN(pretrained=False, action_size=6, in_channels=1, **kwargs):
    """Constructs a ResNet-18 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_DQN(BasicBlock, [2, 2, 2, 2], action_size=6, in_channels=1, **kwargs)
    return model
...
class DQNAgent():
    def __init__(self, action_size):
        ...
        self.memory_size = 20000*50//2
        self.epsilon = 1.0 
        self.epsilon_min = 0.01*5
        self.explore_step =50000*10 #5000*20
